 ...
 */
fun lengthInMeters(sagenes: Int, arshins: Int, vershoks: Int): Double = (4.445 * 48 * 3 * sagenes + 4.445 * 48 * arshins + 4.445 * vershoks) / 100
...
fun angleInRadian(deg: Int, min: Int, sec: Int): Double {
    val degrees: Double = deg.toDouble() + (min.toDouble()) / 60 + (sec.toDouble()) / 3600
